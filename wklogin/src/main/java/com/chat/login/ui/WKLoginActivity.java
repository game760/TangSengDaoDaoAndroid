...
public class WKLoginActivity extends WKBaseActivity<ActLoginLayoutBinding> implements LoginContract.LoginView {
    ...
    protected void initView() {
      ...
      //  wkVBinding.forgetPwdTv.setTextColor(Theme.colorAccount);
        ...
        wkVBinding.privacyPolicyTv.setOnClickListener(v -> showWebView("https://open.queryip.top/privacy_policy"));
        wkVBinding.userAgreementTv.setOnClickListener(v -> showWebView("https://open.queryip.top/user_agreement"));
